...
private:
    ...
    ros::ServiceServer arm_pos_horizental_open_claw_service;
    ros::ServiceServer arm_pos_horizental_close_claw_service;
    ...
    bool arm_position_horizental_open_claw_callback(upros_message::ArmPosition::Request &req, upros_message::ArmPosition::Response &resp);
    bool arm_position_horizental_close_claw_callback(upros_message::ArmPosition::Request &req, upros_message::ArmPosition::Response &resp);
