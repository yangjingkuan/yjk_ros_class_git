...
int main(int argc, char** argv) {
    ...
    ros::Subscriber sub_2 = nh.subscribe<sensor_msgs::Range>("/us/tof2", 10, rangeCallback2);
    ros::Subscriber sub_3 = nh.subscribe<sensor_msgs::Range>("/us/tof3", 10, rangeCallback3);
    ros::Subscriber sub_4 = nh.subscribe<sensor_msgs::Range>("/us/tof4", 10, rangeCallback4);
    ros::spin();
    return 0;
}